...
describe('Titanium.UI', function () {
	...
	describe('#convertUnits()', function () {
		...
		// On Windows, this does nothing because default unit is "px" on Windows.
		...
		// cm -> dip
		it.windowsBroken('returns 2.54 cm = (dpi / logicalDensityFactor) dip', function () {
			var logicalDensityFactor = Ti.Platform.displayCaps.logicalDensityFactor;
		...
		it.windowsBroken('returns 2.54cm = dpi pixels', function () {
			var dpi = Ti.Platform.displayCaps.dpi;
			should(Ti.UI.convertUnits('2.54cm', Ti.UI.UNIT_PX)).be.approximately(dpi, 0.0001);
		});

		// dip -> cm
		it.windowsBroken('returns (dpi / logicalDensityFactor) dip = 2.54 cm', function () {
			var logicalDensityFactor = Ti.Platform.displayCaps.logicalDensityFactor;
			var dpi = Ti.Platform.displayCaps.dpi;
		...
		// dip -> in
		it.windowsBroken('returns (dpi / logicalDensityFactor) dip = 1 in', function () {
			var logicalDensityFactor = Ti.Platform.displayCaps.logicalDensityFactor;
			var dpi = Ti.Platform.displayCaps.dpi;
		...
		// dip -> mm
		it.windowsBroken('returns (dpi / logicalDensityFactor) dip = 25.4 mm', function () {
			var logicalDensityFactor = Ti.Platform.displayCaps.logicalDensityFactor;
			var dpi = Ti.Platform.displayCaps.dpi;
		...
		// dip -> px
		it.windowsBroken('returns Ti.Platform.DisplayCaps.logicalDensityFactory for 1dip to pixels', function () {
			var logicalDensityFactor = Ti.Platform.displayCaps.logicalDensityFactor;
		...
		// inches -> dip
		it.windowsBroken('returns 1 in = (dpi / logicalDensityFactor) dip', function () {
			var logicalDensityFactor = Ti.Platform.displayCaps.logicalDensityFactor;
			var dpi = Ti.Platform.displayCaps.dpi;
		...
		// inches -> pixels
		it.windowsBroken('converts 1 in = dpi pixels', function () {
			var dpi = Ti.Platform.displayCaps.dpi;
		...
		// mm -> dip
		it.windowsBroken('returns 25.4 mm = (dpi / logicalDensityFactor) dip', function () {
			var logicalDensityFactor = Ti.Platform.displayCaps.logicalDensityFactor;
			var dpi = Ti.Platform.displayCaps.dpi;
		...
		it.windowsBroken('returns 25.4 mm = dpi pixels', function () {
			var dpi = Ti.Platform.displayCaps.dpi;
		...
		it.windowsBroken('returns dpi pixels = 2.54 cm', function () {
			var dpi = Ti.Platform.displayCaps.dpi;
			should(Ti.UI.convertUnits(dpi + 'px', Ti.UI.UNIT_CM)).be.approximately(2.54, 0.0001);
		});

		// px -> dip
		it.windowsBroken('returns Ti.Platform.DisplayCaps.logicalDensityFactory pixels = 1 dip', function () {
			var logicalDensityFactor = Ti.Platform.displayCaps.logicalDensityFactor;
		...
		it.windowsBroken('converts dpi pixels = 1 in', function () {
			var dpi = Ti.Platform.displayCaps.dpi;
		...
		it.windowsBroken('returns dpi pixels = 25.4 mm', function () {
			var dpi = Ti.Platform.displayCaps.dpi;
		...
		it('returns 0 if percentage used', function () {
