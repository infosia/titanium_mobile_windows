...
namespace TitaniumWindows
{
	namespace UI
	{
		...
		JSObject ScrollViewLayoutDelegate::CreateClickCallback(const JSObject& contentView) TITANIUM_NOEXCEPT
		{
			...
			return static_cast<JSObject>(contentView.get_context().JSEvaluateScript(script));
		}
